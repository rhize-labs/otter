...
impl<'a> Cursor<'a> {
    ...
    pub fn next(&'a self) -> Option<&'a Node> {
        //assert!(self.valid());
    ...
    pub fn prev(&'a self) -> Option<&'a Node> {
        //assert!(self.valid());
    ...
    pub fn seek(&'a self, target: &[u8]) -> Option<&'a Node> {
    ...
    pub fn seek_for_prev(&'a self, target: &[u8]) -> Option<&'a Node> {
    ...
    pub fn seek_for_last(&'a self) -> Option<&'a Node> {
